...
function Footer() {
  return (
    <footer>
      ...
      <p>A portfolio designed & built by <a href="https://www.linkedin.com/in/md-nazrul-islam-a479b725/" target="_blank" rel="noreferrer">Md Nazrul Islam</a> with react framework & online help</p>
    </footer>
  );
}
